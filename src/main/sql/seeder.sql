...
INSERT into posts (user_id, thread_id, title, message)
VALUES (1, 1, 'First time eating food!', 'I never tried eating food before, but gave it a shot today. Definately gonna make this a habbit.'),
    (2, 2, 'Why is there no good Country Music?', 'The title speaks for itself. I never hear good country on the radio :('),
    (3, 3, 'Telepaths Unite!', '...silently, over vast distances...');